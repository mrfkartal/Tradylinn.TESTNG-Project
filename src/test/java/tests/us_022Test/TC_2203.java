...
public class TC_2203 extends TestBaseRapor {

    //us_0022_tradylinnPage testPage1 = new us_0022_tradylinnPage();
    us_0022_tradylinnPage us_0022_tradylinnPage ;

    @Test
    public void test2202() throws InterruptedException {
        extentTest=extentReports.createTest("US022_TC2203",
                "Indirimli urun sayfasinda sirala butonundaki" +
                        " Fiyata gore sirala: Dusukten yuksege sayfasindaki urunlerin " +
      ...
      for (int i = 0; i < us_0022_tradylinnPage.indirimliurunlerList.size(); i++) {
       ...
       for (int i = 0; i < urunlerinFiyatListesi.size()-1 ; i++) {
        ...
        extentTest.pass("Indirimli urunler-> Fiyata gore sirala: Dusukten yuksege sayfasindaki" +
