...
public class TC_1702 extends TestBaseRapor {
    US_16_17_TradylinnPage tradylinnPage;
    @Test

    public void tc_1702() {
        extentTest=extentReports.createTest("1702","Vendor müşterileri shiping ve billing adresleri ile aynı bilgilerle ekler");
        ...
        actions.click(tradylinnPage.userNameButonu).
                ...
                sendKeys(Keys.TAB).sendKeys(Keys.TAB).sendKeys("Alasehir").
                sendKeys(Keys.TAB).sendKeys("Malatya").
                sendKeys(Keys.TAB).sendKeys("123321").perform();
        ...
        actions.sendKeys(Keys.TAB).sendKeys(Keys.TAB).
                ...
                sendKeys(Keys.TAB).sendKeys(fakeAdress1).
                sendKeys(Keys.TAB).sendKeys(fakeAdress2).
                sendKeys(Keys.TAB).sendKeys(Keys.ENTER).sendKeys(Keys.ENTER).
                sendKeys(Keys.TAB).sendKeys(Keys.TAB).sendKeys("Alasehir").
                sendKeys(Keys.TAB).sendKeys("Malatya").
                sendKeys(Keys.TAB).sendKeys("123321").
                perform();
        extentTest.info("Yeni ekleyeceği kişinin isim,soyisim,telefon,şirket adını ve billing ile shipping adres bilgilerini aynı olarak doldurur");
        ...
        extentTest.pass("Shipping ve billing kısmındaki adres bilgilerinin aynı olduğunu doğrular");
