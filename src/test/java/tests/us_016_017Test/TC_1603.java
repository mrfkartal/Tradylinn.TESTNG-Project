...
public class TC_1603 extends TestBaseRapor {
    US_16_17_TradylinnPage tradylinnPage;
    @Test

    public void tc_1603() {

        extentTest=extentReports.createTest("1603","Vendor müşterileri kullanıcı adı,ismi,soyismi ve emaili ile ekler");
        ...
        ReusableMethods.waitFor(6);
        extentTest.info(" Kullanıcı adi, email, isim bilgilerini doldurarak yeni kisi ekler");

          Assert.assertTrue(tradylinnPage.editCostomerYazisi.isDisplayed());
        extentTest.pass("Edit Customer” yazısının görünürlüğünü doğrular");
