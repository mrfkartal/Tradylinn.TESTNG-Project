...
public class TC_1802 extends TestBaseRapor {
    US_18_TradylinnPage US_18_TradylinnPage;

    @Test
    public void test_US18_TC02() {

        extentTest = extentReports.createTest("US_018_TC_1802 ", "OrderId bilgilerinin gorunmesi");
      ...
      US_18_TradylinnPage = new US_18_TradylinnPage();
        ...
        //9-Vendor geri odeme listesinde orderId oldugunu test eder

        if (!(US_18_TradylinnPage.orderIdListesi.isEmpty())){


            for (int i = 0; i <US_18_TradylinnPage.orderIdListesi.size() ; i++) {

                Assert.assertTrue(US_18_TradylinnPage.orderIdListesi.get(i).isDisplayed());

                System.out.println(US_18_TradylinnPage.orderIdListesi.get(i).getText());

            }
            System.out.println("OrderId listesi gorundu");
            extentTest.pass("OrderId listesinin dolu oldugu test edildi");
